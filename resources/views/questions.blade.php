...
<form class="quizQuestion" id="submitForm">
        <input type="hidden"  name="subjectid" id="subjectId" value="@if(Session::get('subjectId'))
    ...
    <input type="text" name="option_a" id="option1"><p>
    <span id="optionA" style="color:red"></span>
    <label>Option 2</label>
    <input type="text" name="option_b" id="option2"><p>
        <span id="optionB" style="color:red"></span>
   <label>Option 3</label>
<input type="text"name="option_c" id="option3"><p>
    <span id="optionC" style="color:red"></span><p>
    <label>Option 4</label>
<input type="text" name="option_d" id="option4"><p>
